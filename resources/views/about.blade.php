      ...
      <div class="row justify-content-between flex-wrap-reverse gy-4">
         <div class="col-lg-6">
            <div class="about__thumb">
               <div class="thumb">
                  <img src="{{asset('assets/images/frontend/about/6215d5c3b5a6d1645598147.jpg')}}" alt="about">
                  <a href="https://www.youtube.com/watch?v=WOb4cj7izpE" class="video-button" data-lightbox><i class="las la-play"></i></a>
               </div>
            </div>
         </div>
      ...
      <div class="row justify-content-center">
         <div class="col-lg-6 col-md-10">
            <div class="section__header text-center">
               ...
               <p>
                  Our top client's. If you want to showcase yourself you must have an MLM.
               </p>
            </div>
         </div>
      </div>
         ...
         <div class="col-xl-4 col-md-6">
            <div class="team__item">
               <div class="team__thumb">
                  <img src="{{asset('assets/images/user/profile/1646148109_testuser.jpg')}}" alt="profile">
               </div>
...
<section class="how-to-section bg--title shapes-container">
   <div class="banner-shape shape1">
      <img src="{{asset('assets/templates/basic/images/banner/shapes/1.png')}}" alt="banner/shapes">
   </div>
   <div class="banner-shape shape2">
      <img src="{{asset('assets/templates/basic/images/banner/shapes/2.png')}}" alt="banner/shapes">
   </div>
   <div class="banner-shape shape3">
      <img src="{{asset('assets/templates/basic/images/banner/shapes/3.png')}}" alt="banner/shapes">
   </div>
   <div class="banner-shape shape4">
      <img src="{{asset('assets/templates/basic/images/banner/shapes/4.png')}}" alt="banner/shapes">
   </div>
   <div class="banner-shape shape6">
      <img src="{{asset('assets/templates/basic/images/banner/shapes/6.png')}}" alt="banner/shapes">
   </div>
   <div class="container">
      <div class="row justify-content-center">
         <div class="col-lg-6 col-md-10">
            <div class="section__header text-center text-white">
               ...
               <p>
                  Follow the steps to enter into the platform and get the services.
               </p>
            </div>
         </div>
      </div>
